...
if((method=="JMA") & model!="gaussian"){stop("Jackknife Model Averaging only works for the linear model.")}
if(criterion=="BIC+"){
...
if(method=="MMA"){cat("Note: The results of MMA depend on the ordering of the regressors, unless using model.subset='all'; see manual. \n (see manual to see if and how to calculate standard errors) \n")}
if(method=="JMA"){cat("Note: The results of JMA depend on the ordering of the regressors, unless using model.subset='all'; see manual. \n (see manual to see if and how to calculate standard errors) \n")}
...
if(report.exp==TRUE & model=="gaussian"){warning("Exponentiated coefficients are not always meaningful for the linear model. \n")}
