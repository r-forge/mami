...
if(ncores>1 & missing.data=="imputed" & imp.method=="amelia"){snow::clusterExport(cl, c("am"),envir=environment())}
if(ncores>1 & missing.data=="imputed" & imp.method=="mice"){snow::clusterExport(cl, c("mp","mice::mice.impute.polyreg", "mice::mice.impute.norm", "mice::mice.impute.norm"),envir=environment())}
