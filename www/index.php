...
<!-- end of project description -->
 ...
 <ul>
  ...
  e.g. recent shrinkage methods or boosting, p-value based approaches, in depth Bayesian Model Averaging,...You may however still want to consult the reference below.</p>
         </li>
         <li align="justify">
         <p align="justify">If you want to utilize model averaging based on exponential AIC weights and you have a massive amount of variables,
  see ?mami -> Details for more information</p>
         </li>
 </ul>
...
<p> The <package can be downloaded <a href="https://r-forge.r-project.org/R/?group_id=2152"><strong>here</strong></a>. </p>
