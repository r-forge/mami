...
<p> The package can be downloaded <a href="https://r-forge.r-project.org/R/?group_id=2152"><strong>here</strong></a> (do not forget to also install the dependencies).</p> <p>Or simply type <strong><tt> install.packages("MAMI", repos=c("http://R-Forge.R-project.org","http://cran.at.r-project.org"), dependencies=TRUE)</tt></strong> in <i>R</i>. </p>
